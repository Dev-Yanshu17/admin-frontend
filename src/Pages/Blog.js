      ...
      <div className="form-card">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-grid">
            ...
            <input name="link" placeholder="Read More Link" value={form.link} onChange={handleChange} required />
            <input name="readTime" placeholder="Read Time (e.g. 5 min)" value={form.readTime} onChange={handleChange} required />
            <input name="authorName" placeholder="Author Name" value={form.authorName} onChange={handleChange} required/>   
            <input name="authorRole" placeholder="Author Role" value={form.authorRole} onChange={handleChange} required/>
          </div>
